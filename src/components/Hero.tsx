...
export default function Hero({ onNavigate }: HeroProps) {
  ...
  return (
    <section className="relative min-h-screen flex items-center px-6 sm:px-8 lg:px-12 overflow-hidden bg-ink-950 pt-20">
      ...
      <div className="relative section-container w-full">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          <div className="lg:col-span-7 space-y-8">
            ...
            <p className="text-lg sm:text-xl text-ink-400 max-w-2xl mx-auto lg:mx-0 leading-relaxed animate-slide-up" style={{ animationDelay: '0.16s' }}>
              {content.description}
            </p>
          ...
          <div className="lg:col-span-5 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            <div className="relative aspect-[4/5] max-w-md mx-auto lg:max-w-none rounded-3xl overflow-hidden shadow-elevated">
              ...
              <div className="absolute bottom-6 left-6 right-6 glass-dark rounded-2xl p-4">
                ...
                <p className="text-ink-400 text-xs mt-0.5">UI/UX Architect · Senior Product Designer</p>
              </div>
            </div>
          </div>
        </div>
